...
import txcap.com.viewdemo.DensityUtils;
...
public class DonutProgress extends View {
    ...
    protected void initPainters() {
        ...
        LinearGradient rg = new LinearGradient(0,0,400,400, Color.YELLOW, Color.RED, Shader.TileMode.CLAMP);
        finishedPaint = new Paint();
        finishedPaint.setShader(rg);
        finishedPaint.setStyle(Paint.Style.STROKE);
        finishedPaint.setAntiAlias(true);
        finishedPaint.setStrokeWidth(finishedStrokeWidth);
        finishedPaint.setPathEffect(new DashPathEffect(new float[]{5, 8}, 0));
        ...
        unfinishedPaint.setPathEffect(new DashPathEffect(new float[]{5, 8}, 0));
...
/*        canvas.drawArc(finishedOuterRect, 0, getProgressAngle(), false, finishedPaint);
        canvas.drawArc(unfinishedOuterRect, 0, 360 - getProgressAngle(), false, unfinishedPaint);*/
