...
public class CircleTextProgressbar extends TextView {
     ...
     * 中心圆的颜色。
     */
    private int circleColor = 0x3F51B5;

    /**
     * 进度条的颜色。
     */
    private int progressLineColor = 0x303F9F;

    /**
     * 进度条的宽度。
     */
    private int progressLineWidth = 30;
...
//        int circleColor = inCircleColors.getColorForState(getDrawableState(), 0);
        ...
        canvas.drawArc(mArcRect, 0, progress, false, mPaint);
    }
