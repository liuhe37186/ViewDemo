...
/**
 * 文件名:txcap.com.viewdemo.CustomView.HeadZoomScrollView
 * 描 述:
 * 作 者:liuhe
 * 时 间:2017-05-02 10:27
 */
...
//        设置控件水平居中
        ...
        if(coverView != null){
            ViewGroup.LayoutParams layoutParams1 = coverView.getLayoutParams();
            ((MarginLayoutParams) layoutParams1).setMargins(0, (int) s, 0, 0);
            coverView.setLayoutParams(layoutParams1);
        }
